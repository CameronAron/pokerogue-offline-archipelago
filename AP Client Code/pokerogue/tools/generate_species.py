...
#: at all -- see __init__.py's create_regions. Hand-curated; re-verify against
#: the source above after a regeneration, since a game update could add or
#: remove a species from either list.
